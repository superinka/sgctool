                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <h3><?php echo $info_employee->fullname; ?></h3>
                      ...
                      <?php if (($account_type==1) || ($user_id==$now_id)) {
                        # code...
                        echo '<a href="'.'" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>';
                      } ?>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Báo cáo mới nhất</a>
                          </li>
                          <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Dự án đang tham gia</a>
                          </li>
                        ...
                        <div id="myTabContent" class="tab-content">
                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                            ...
                            <ul class="messages">
                              <li>
                                <img src="<?php echo admin_theme('');?>/production/images/user.png" class="avatar" alt="Avatar">
