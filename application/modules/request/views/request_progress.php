...
if($old_status==0){$new_status = 100;}
else {$new_status = 0;}
?>
<div class="col-md-12">
<div class="row">
		    ...
		    <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" action="" method="post">
			  ...
			  <div class="form-group">
				  ...
				  <div class="col-md-4 col-sm-4 col-xs-12" style="padding-top: 8px">
				    <?php if($old_status==100) {echo'Hoàn thành';} else {echo 'Không hoàn thành';} ?>:
				    <input type="radio" class="flat" name="status" id="status1" checked value="0" />
				  </div>
		      </div>
...
<!-- 		      <div class="form-group">
			  ...
			  <div class="form-group">
			      <label class="control-label col-md-2 col-sm-2 col-xs-12">Tiến độ mới</label>
				  <div class="col-md-4 col-sm-4 col-xs-12" style="padding-top: 8px">
				   	<?php if($new_status==100) {echo'Hoàn thành';} else {echo 'Không hoàn thành';} ?>:
				    <input type="radio" class="flat" name="status" id="status2" checked value="<?php echo $new_status ?>" />
				  </div>
		      </div>
<!-- 			  <div class="form-group">
				  ...
				  <div class="col-md-4 col-sm-4 col-xs-12" style="padding-top: 8px">
				   	Đồng ý:
				    <input type="radio" class="flat" name="solve" id="solve1" value="2" />
				   	Không đồng ý:
				    <input type="radio" class="flat" name="solve" id="solve2" checked value="1" />
				  </div>
		      </div> -->
		      <div class="ln_solid"></div>
		      <div class="form-group">
